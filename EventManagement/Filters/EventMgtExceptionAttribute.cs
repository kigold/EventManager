...
{
    public class EventMgtExceptionAttribute : ExceptionFilterAttribute
    {
        private readonly IHostingEnvironment _env;
        private readonly ILogger _logger;

        public EventMgtExceptionAttribute(IHostingEnvironment env, ILogger<EventMgtExceptionAttribute> logger)
        {
            _env = env;
            _logger = logger;
        }
